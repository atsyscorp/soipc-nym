...
<body class="bodygen bgcol_2" onload="frOpsClientes_Load('', '')">
<?=$msbloc=dBloc()?>
			...
			<div class="bgcol_2" align="left" style="width:100%">
				...
				<div style="margin:8px">
					<div style="margin-top:8px">
						<div style="float:left; margin-right:8px" class="fgreen"><strong>Información del beneficiario</strong></div>
						<div style="position:absolute; visibility:hidden" class="fcont"><input type="radio" name="rbDecben" id="rbDecben" value="mismo" onclick="rbDecBen_Clic()">Mismo beneficiario <input type="radio" name="rbDecben" id="rbDecben" value="diferente" checked="checked" onclick="rbDecBen_Clic()">Diferente beneficiario</div>
						<div style="float:right; width:470px; margin-top:9px" class="dlin_4"></div>
					</div>
					<div style="clear:both"></div>
					<div style="margin-top:8px; overflow:hidden">
						<div style="float:left; width:312px; overflow:hidden">
							<table style="width:100%" cellpadding="0" cellspacing="0">
								...
								<tr class="trtxco">
									...
									<td align="right">
										<select name="Tipo_Documento" id="tx4" style="width:204px" class="txboxo" onchange="cbDoc_Change()" >
											<option value=""></option>
											<?=$cbTD=LoadConfTab($link, "SELECT Tipo_Documento FROM XConf_TiposDoc WHERE Tipo_Cliente = 'BEN' OR Tipo_Cliente = 'AMB'")?>
										</select>
									</td>
								</tr>	
								<tr class="trtxco">
								...
								<tr class="trtxco">
									<td style="width:108px; text-align:left" class="fcont">Lugar constituc.:</td>
									<td align="right">
						...
						<div style="float:right; width:312px; overflow:hidden">
							<table style="width:100%" cellpadding="0" cellspacing="0">
								...
								<tr class="trtxco">
									...
									<td align="right"><input name="Email" id="tx18" maxlength="45" class="txboxo" style="width:198px; text-align:left" value="" /></td>					
								</tr>
								<tr class="trtxco">
								...
								<tr class="trtxco">
									<td style="width:108px; text-align:left" class="fcont">Fecha constituc.:</td>
									<td align="right">
								...
								<tr class="trtxco">
									<td style="width:108px; text-align:left" class="fcont">Participación socios:</td>
									<td align="right"><textarea name="Observaciones" cols="0" class="txbox" id="tx22" style="width:198px; overflow:auto; height:46px; resize:none;" maxlength="100"></textarea><!-- <input name="Observaciones" id="tx22" maxlength="90" class="txbox" style="width:198px; text-align:left; height:47px" value="" />--></td>					
								</tr>
							</table>	
						</div>
					</div>					
					...
					<div style="margin-top:7px; overflow:hidden; padding-bottom:3px">
						...
						<div style="float:left; margin-right:10px"><input name="btgocom" id="btgocom" type="button" value="Ir a Compra" class="btcontdis" style="width:88px;" onclick="window.parent.document.getElementById('btgocom').disabled=false; window.parent.document.getElementById('btgocom').click()" disabled="disabled" /></div>
						<div style="float:left; margin-right:10px"><input name="btgoven" id="btgoven" type="button" value="Ir a Venta" class="btcontdis" style="width:88px;" onclick="window.parent.document.getElementById('btgoven').disabled=false; window.parent.document.getElementById('btgoven').click()" disabled="disabled" /></div>
						<div style="float:left;"><input name="btexit" id="btexit" type="button" value="Salir" class="btcont" style="width:88px;" onclick="window.parent.document.getElementById('btexit').click()" /></div>
						<div style="float:left; visibility:hidden"><input name="btben" id="btben" type="button" value="" class="" style="width:0px;" /></div>
						...
						<input type="hidden" name="Contacto" id="tx28" value="" />
						<input type="hidden" name="Parentesco" id="tx29"  value=""/>	
						<input type="hidden" name="Tel_Contacto" id="tx30" value="" />											
