			...
			<div class="drod_1 dlin_1 dsom_3 bgcol_2" align="left" style="width:100%">
				...
				<div style="margin:8px">
						...
						<div style="float:left; width:185px; overflow:visible">
							<table style="width:100%" cellpadding="0" cellspacing="0">
								<tr class="trtxco">
									...
									<td align="right">
										<select name="Sucursal" id="tx1" style="width:80px;" class="txboxo" onchange="txId_Change()">
											<option value=""></option>
								...
								<tr class="trtxco">
									...
									<td align="right">
										<select name="Copias_Compra" id="tx2" style="width:80px;" class="txboxo" onchange="">
											<option value=""></option>
								...
								<tr class="trtxco">
									...
									<td align="right">
										<select name="Copias_Venta" id="tx3" style="width:80px;" class="txboxo" onchange="">
											<option value=""></option>
											<option value="1">1</option>
											<option value="2">2</option>
											<option value="3">3</option>
						...
						<div style="float:right; width:305px; overflow:visible">
							<table style="width:100%" cellpadding="0" cellspacing="0">
								<tr class="trtxco">
									...
									<td align="right"><input name="Fin_Consecutivo" id="tx4" maxlength="30" class="txboxo" style="width:165px; text-align:left" value="" onkeydown="return Onlynum(this, event)"/></td>
								</tr>
								<tr class="trtxco">
									<td style="text-align:left" class="fcont">Resolución facturación:</td>
									<td align="right"><input name="Resolucion" id="tx5" maxlength="40" class="txboxo" style="width:165px; text-align:left" value="" onkeydown="return Onlynum(this, event)"/></td>
								</tr>
								<tr class="trtxco">
					...
					<div style="margin-top:7px">
						...
						<input type="hidden" name="Fecha_Final" id="tx6" value=""  />
					</div>
					<div style="clear:both"></div>
