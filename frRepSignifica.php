...
<div align="center" style="width:100%; margin-top:25px;">
	...
	//Carga combo segmentos
	$strSQD = "SELECT DISTINCT(Grupo) FROM Segmentos_Mercado";
	//-------------------------------------------------
	...
	<div align="center" style="width:440px; position:relative">
		...
		<div class="drod_1 dlin_1 dsom_3 bgcol_2" align="left" style="width:100%">
			<div class="bgcol_6" style="overflow:hidden">
				<div style="float:left; font-weight:bold; margin-left:5px; margin-top:6px" class="fwhite">Reporte operaciones significativas</div>
			...
			<div style="margin:0px">
					...
					<div id="dCriConsultaT">
						<table style="width:100%" cellpadding="0" cellspacing="0">
							...
							<tr class="trtxco">
								...
								<td align="right">
									<select name="Grupo_Segmento" id="tx3" style="width:100%;" class="txboxo">
										<option value=""></option>
										<option value="TODOS">TODOS</option>
										<?=$cbLoad=LoadConfTab($link, $strSQD)?>
									</select>
								</td>
							</tr>						
							<tr class="trtxco">
							...
							<tr class="trtxco">
								...
								<td align="right"><input type="date" name="Fecha" id="tx5" maxlength="30" class="txboxo" style="width:98%;" value="" /></td>
							</tr>						
							<tr class="trtxco">
								<td style="text-align:left" class="fcont">Operación o acumulado:</td>
								<td align="right">
									<select name="CalType" id="tx6" style="width:100%;" class="txboxo" onChange="Sel_AcumC()">
										<option value=""></option>
							...
							<tr class="trtxco">
								<td style="text-align:left" class="fcont">En Divisa o USD:</td>
								<td align="right">
									<select name="CalCur" id="tx7" style="width:100%;" class="txboxo">
										<option value=""></option>
										<option value="CANTIDAD DIVISA">CANTIDAD DIVISA</option>
										<option value="VALOR EN USD">VALOR EN USD</option>
									</select>
								</td>
							</tr>						
							<tr class="trtxco">
								<td style="text-align:left" class="fcont">Calificación superior a:</td>
								<td align="right"><input name="CalSup" id="tx8" maxlength="20" class="txboxo" style="width:98%; text-align:right; font-weight:bold" value="0" onkeydown="return OnlynumDec(this, event)" /></td>
							</tr>						
							<tr class="trtxco">
								<td style="text-align:left" class="fcont">Ordenar por:</td>
								<td align="right">
									<select name="cbOrder" id="tx9" style="width:100%;" class="txbox" onChange="Sel_OrderC()">
										<option value=""></option>
										<?php
										for ($j = 0; $j <= $ic - 1; $j++) {
										?>
							...
							<tr class="trtxco">
								...
								<td align="right">
									<select name="cbOrderType" id="tx10" style="width:100%;" class="txbox">
										<option value=""></option>
				...
				<div style="margin:10px 8px">
					<div style="float:left; margin-right:10px"><input name="btacceptgen" id="btacceptgen" type="button" value="Generar reporte" class="btcont" style="width:120px;" onclick="RepSignifica()" /></div>
