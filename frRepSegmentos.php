...
<div align="center" style="width:100%; margin-top:25px;">
	...
	$strSQS = "SELECT DISTINCT(Grupo) FROM Segmentos_Mercado";
	//Carga combo monedas
	...
	<div align="center" style="width:440px; position:relative">
		...
		<div class="drod_1 dlin_1 dsom_3 bgcol_2" align="left" style="width:100%">
			<div class="bgcol_6" style="overflow:hidden">
				<div style="float:left; font-weight:bold; margin-left:5px; margin-top:6px" class="fwhite">Reporte segmentación</div>
			...
			<div style="margin:0px">
					...
					<div id="dCriConsultaT">
						<table style="width:100%" cellpadding="0" cellspacing="0">
							...
							<tr class="trtxco">
								...
								<td align="right">
									<select name="Grupo_Segmento" id="tx2" style="width:100%;" class="txboxo">
										<option value=""></option>
							...
							<tr class="trtxco">
								...
								<td align="right">
									<select name="cbOrder" id="tx6" style="width:100%;" class="txbox" onChange="Sel_OrderC()">
										<option value=""></option>
										<?php
										for ($j = 0; $j <= $ic - 1; $j++) {
										?>
							...
							<tr class="trtxco">
								...
								<td align="right">
									<select name="cbOrderType" id="tx7" style="width:100%;" class="txbox">
										<option value=""></option>
				...
				<div style="margin:10px 8px">
					<div style="float:left; margin-right:10px"><input name="btacceptgen" id="btacceptgen" type="button" value="Generar reporte" class="btcont" style="width:120px;" onclick="RepSegmentos()" /></div>
