<!-- Ventana consulta consolidad de clientes -->
	...
	<div align="center" style="width:440px; position:relative">
		...
		<div class="drod_1 dlin_1 dsom_3 bgcol_2" align="left" style="width:100%">
			<div class="bgcol_6" style="overflow:hidden">
				<div style="float:left; font-weight:bold; margin-left:5px; margin-top:6px" class="fwhite">Consolidado de cliente</div>
			...
			<div style="margin:0px">
					...
					<div id="dCriConsultaT">
						<table style="width:100%" cellpadding="0" cellspacing="0">
							...
							<tr class="trtxco">
								...
								<td align="right"><input name="Documento_Beneficiario" id="tx2" maxlength="30" class="txboxo" style="width:98%;" value="" /></td>
							</tr>						
							<tr class="trtxco">
							...
							<tr class="trtxco">
								<td style="text-align:left" class="fcont">Moneda:</td>
								<td align="right">
				...
				<div style="margin:10px 8px">
					<div style="float:left; margin-right:10px"><input name="btacceptgen" id="btacceptgen" type="button" value="Generar reporte" class="btcont" style="width:120px;" onclick="RepConsCli()" /></div>
