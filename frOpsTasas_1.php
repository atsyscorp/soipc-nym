<?php
	...
	$strSQL = "SELECT Codigo_Sucursal FROM Sucursales";
	//---------------------------------------------------
	//Carga combo monedas
...
<script src="scripts/frOpsTasas_1.js" type="text/javascript"></script>
</head>
				...
				<div style="margin:8px">
					<div>
						<table style="width:100%" cellpadding="0" cellspacing="0">
							<tr class="trtxco">
								<td style="width:125px; text-align:left" class="fcont">Seleccione sucursal:</td>
								<td align="right">
									<select name="Sucursal" id="tx1" style="width:144px; margin-left:10px" class="txboxo" onchange="Suc_Change()">
										<option value=""></option>
							...
							<tr class="trtxco">
								<td style="width:125px; text-align:left" class="fcont">Seleccione estación:</td>
								<td align="right">
									<select name="Estacion" id="tx2" style="width:144px; margin-left:10px" class="txboxo" onchange="Caja_Change()">
										<option value=""></option>
									</select>
								</td>
							</tr>
							<tr class="trtxco">
								...
								<td align="right">
									<select name="Moneda" id="tx3" style="width:144px; margin-left:10px" class="txboxo" onchange="Moneda_OnChange()">
										<option value=""></option>
