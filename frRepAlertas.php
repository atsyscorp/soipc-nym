	...
	<div align="center" style="width:440px; position:relative">
		...
		<div class="drod_1 dlin_1 dsom_3 bgcol_2" align="left" style="width:100%">
			<div class="bgcol_6" style="overflow:hidden">
				<div style="float:left; font-weight:bold; margin-left:5px; margin-top:6px" class="fwhite">Reporte señales de alerta</div>
			...
			<div style="margin:0px">
					...
					<div id="dCriConsultaT">
						<table style="width:100%" cellpadding="0" cellspacing="0">
							...
							<tr class="trtxco">
								...
								<td align="right">
									<select name="Moneda" id="tx3" style="width:100%;" class="txboxo">
										<option value=""></option>
										<option value="TODAS">TODAS</option>
							...
							<tr class="trtxco">
								<td style="text-align:left" class="fcont">Tipo de calificación:</td>
								<td align="right">
									<select name="CalType" id="tx6" style="width:100%;" class="txboxo">
										<option value=""></option>
										<option value="Alerta_Sistema">Alerta de sistema</option>
										<option value="Alerta_Cajero">Alerta de cajero</option>
										<option value="Alerta_Total">Alerta total</option>
									</select>
								</td>
							</tr>						
							<tr class="trtxco">
								<td style="text-align:left" class="fcont">Calificación superior a:</td>
								<td align="right"><input name="CalSup" id="tx7" maxlength="30" class="txboxo" style="width:98%; text-align:right; font-weight:bold" value="0" onkeydown="return OnlynumDec(this, event)" /></td>
							</tr>						
							<tr class="trtxco">
				...
				<div style="margin:10px 8px">
					<div style="float:left; margin-right:10px"><input name="btacceptgen" id="btacceptgen" type="button" value="Generar reporte" class="btcont" style="width:120px;" onclick="RepAlertas()" /></div>
