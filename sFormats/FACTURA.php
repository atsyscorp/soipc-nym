...
$var[2]=(isset($_GET['var2'])) ? $_GET['var2'] : '';	//Cuando es por buscar operacion la variable es no vacia y carga seccion de conocimiebnto del cliente
...
// Obtener la cantidad de meses a partir de una fecha inicial y final
...
<body class="bodygen" style="font-size:9px" onload="">
	<div style="width:250px; margin-top:10px; margin-left:0px">
		<div style="text-align:center"><img src="../images/Logo-Negro.png" style="width:230px; height:auto"></div>
			<?php if($varp[48] != 'EFECTIVO' && $varp[33] != 'TUSD'){	//Persona juridica ?>

				<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top:0px">
					<tr style="vertical-align:bottom">
						<td style="text-align:center; font-weight:bold"; colspan="2">
							NOTA DE ENTREGA, DEBIDA DILIGENCIA  POR COMPRA Y VENTA DE MANERA PROFESIONAL DE DIVISAS Y CHEQUES DE VIAJERO</br>
							TIPO DE OPERACIÓN VENTA - COD 16</td>
					</tr>
					<tr style="height:25px; vertical-align:top">
						<td style="text-align:center; border-bottom:#000000 solid 1px; border-top:#000000 solid 1px" colspan="2">
							Formulario DDC Par 2 Art 17 numeral 3.1 Res 061 de 2017
						</td>
					</tr>
					...
					<tr style="height:20px; vertical-align:middle">
						<td style="text-align:center;" colspan="2">
							...
							<div style="text-align:center;">
								Autorización Numeración de Facturación Electrónica <?=$sSucSet[14]?> de <?=$sSucSet[15]?>. 
								Vigencia <?=getMonthsBetweenDates($sSucSet[15], $sSucSet[16])?> meses.
							</div>
							<div style="text-align:center;">Numeración Autorizada <?=$sSucSet[17]?> <?=$sSucSet[12]?> al <?=$sSucSet[13]?></div>
					...
					<tr style="height:28px; vertical-align:middle; font-size:14px">
						...
						<td style="text-align:left; font-weight:bold; border-bottom:#000000 solid 1px"><?=$sSucSet[17]. "-". $cerocon. $varp[10]?></td>
					</tr>
					...
					<?php if($varp[14] == 'NIT'){	//Persona juridica ?>
						<tr style="height:15px; vertical-align:middle">
					...
					<tr style="height:15px; vertical-align:middle">
						...
						<?php /*<td style="text-align:left; font-weight:bold"><?=$vben[20]?></td>*/ ?>
					...
					<?php } ?>
					<?php if($varp[13] != $varp[30]){	//Si declarante y beneficiario son diferentes imprime esta parte de la declaración ?>
					<tr style="height:20px; vertical-align:bottom">
					...
					<tr style="height:15px; vertical-align:middle">
						<td style="text-align:left; font-weight:bold" colspan="2">
							(Datos de la persona natural que suscribe la declaración, en nombre propio o representación del cliente)
						</td>
					</tr>
					<tr style="height:15px; vertical-align:middle">
						<td style="text-align:left;">NOMBRE</td>
					...
					<tr style="height:15px; vertical-align:middle">
						...
						<td style="text-align:center; font-weight:bold; font-size:15px"><?php 
							Gen_Find_Field_1("SELECT Nombre FROM XConf_Monedas WHERE Moneda='".$varp[33]."'"); 
						?></td>
					</tr>
					<tr style="height:15px; vertical-align:middle">
					...
					<tr style="height:15px; vertical-align:middle">
						...
						<td style="text-align:center; font-weight:bold; font-size:13px">
							<?php 
								if($varp[48] == 'EFECTIVO' && $varp[33] != 'TUSD'){
									echo 'COP$ '.number_format($varp[46], 2, $GLdecsepa, $GLmilsepa);
								} else {
									echo 'COP$ 0.00';
								}
							?>
					...
					<tr style="height:15px; vertical-align:middle">
						...
						<td style="text-align:center; font-weight:bold; font-size:15px; border-top:#000000 solid 1px">
							<?='COP$ '.number_format($varp[46], 2, $GLdecsepa, $GLmilsepa)?>
						</td>
					</tr>
				</table>
				<div style="text-align:center; margin-top:5px; font-size:7px">
				...
				<div style="margin-top:10px">
					<div style="float:left; width:170px">
						...
						<div style="text-align:center; margin-top:2px; font-size:10px">
							La factura fue enviada a su correo, si no le llego escribanos a contabilidad@newyorkmoney.com.co
						</div>
					</div>
					<div style="clear:both"></div>
					<?php if($varp[36] >= 1){ // para imprimir DDCI ?>
						<?php if(isset($acumArray)) { ?>
							<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top:0px">
								<tr style="height:15px; vertical-align:middle">
			...
			<?php } else { ?>
				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top:10px">
					<tr style="vertical-align:bottom">
						<td style="text-align:center; font-weight:bold" colspan="2">
							NOTA DE ENTREGA, DEBIDA DILIGENCIA Y DECLARACIÓN DE CAMBIO POR COMPRA Y VENTA DE MANERA PROFESIONAL DE DIVISAS Y CHEQUES DE VIAJERO</br>
							TIPO DE OPERACIÓN VENTA - COD 16
						</td>
					</tr>
					<tr style="height:25px; vertical-align:top">
						<td style="text-align:center; border-bottom:#000000 solid 1px; border-top:#000000 solid 1px" colspan="2">
							Formulario No. 18 Circular Externa DCIN-83 de 03 Octubre 2017, 
							Formato fusionado Par. 1 Art. 17 numeral 3.1 Res 061 de 2017
						</td>
					</tr>
					<tr style="height:15px; vertical-align:middle">
						<td style="text-align:left; width:135px; padding-top:10px">Ciudad</td>
					...
					<tr style="height:15px; vertical-align:middle">
						<td style="text-align:left;">TIPO IDENTIFICACIÓN</td>
						<td style="text-align:left; font-weight:bold">
							<?php Gen_Find_Field_1("SELECT Impresion FROM XConf_TiposDoc WHERE Tipo_Documento='".$varp[14]."'"); ?>
						</td>
					</tr>
					<tr style="height:15px; vertical-align:middle">
						<td style="text-align:left;">NÚMERO</td>
					...
					<?php $separar = explode("-",$vben[20]); //separa la variable de origen de fondos por el ?>
					<tr style="height:15px; vertical-align:middle">
						<td style="text-align:left;">ORIGEN DE FONDOS</td>
						<?php /*<td style="text-align:left; font-weight:bold"><?=$vben[20]?></td> */ ?>
						<td style="text-align:left; font-weight:bold"><?= !empty(trim($separar[0])) ? $separar[0] : "AHORROS"; ?></td>
					</tr>
					<tr style="height:15px; vertical-align:middle">
						<td style="text-align:left;">DESTINO DE FONDOS</td>
						<?php /*<td style="text-align:left; font-weight:bold; border-bottom:#000000 solid 1px">Xp</td> */ ?>
						<td style="text-align:left; font-weight:bold"><?= !empty(trim($separar[1])) ? $separar[1] :"AHORROS"; ?></td>
					</tr>	
					<?php if($varp[14] == 'NIT') { // Persona juridica ?>
						<tr style="height:15px; vertical-align:middle">
							<td style="text-align:left;">NOMBRE, IDENTIFICACIÓN, %PARTICIPACIÓN</td>
					...
					<tr style="height:15px; vertical-align:middle">
						...
						<td style="text-align:center; font-weight:bold; font-size:15px">
							<?php Gen_Find_Field_1("SELECT Nombre FROM XConf_Monedas WHERE Moneda='".$varp[33]."'"); ?>
						</td>
					</tr>
					<tr style="height:15px; vertical-align:middle">
						<td style="text-align:left;">MONTO</td>
		...
		<?php if($acumulado >= 10000){	//validacion para imprimir la DDCI ?>
			...
			<div style="width: 250px; margin-top: 20px; margin-left: 0px;"><br />
				...
				<table style="margin-top: 5px;" border="0" width="100%" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td style="padding: 0; border-bottom: 1px solid black; border-top: 1px solid black; border-left: 1px solid black; border-right: 1px solid black;">SI</td>
						<td style="padding: 0; border-bottom: 1px solid black; border-top: 1px solid black; border-left: 1px solid black; border-right: 1px solid black;">NO</td>
					</tr>
					<tr>
		...
		<div style="clear:both; height:10px;"></div>
			<div style="text-align:center; margin-top:5px; font-size:9px; width: 280px;">
                <span style="font-weight: bold; font-size:13px">ATENCION CLIENTES:</span><br>
                <span style="font-weight: bold; text-decoration: underline;">Todos</span> los billetes tienen nuestro <strong>sello de garantia</strong>.
				<strong>Reviselo</strong> antes de salir. <strong>NO</strong> se aceptan reclamos posteriores. Esto garantiza la autenticidad de su dinero.
            </div>
			<div style="text-align:center; margin-top:5px; font-size:9px; border-top: #000000 solid 1px; padding-top: 5px; width:280px;">
				<span style="font-weight: bold; font-size:13px">ATTENTION CUSTOMERS:</span><br>
...
window.onload = function() { GenPrint1('<?=$var[2]?>'); };
</script>
</html>