...
function cmAccept_Click2()
{
	...
	if(isuc == 10)
	{
		...
		var SaveInvoiceBuyToSend = GenConret_1('General','SaveInvoiceBuyToSend','Factura_Electronica_Compra',IdFactura,false);
...
function Com_Print(iPrint)
{
	...
	{
        //disbtn('btprint');
		var iCPrint = GenConretField('General', 'Gen_Find_Field', "Select Copias_Compra From Configuracion_Contable Where Sucursal ='" + document.getElementById('tx4').value + "' AND Tipo_Resolucion='compra'", false);
