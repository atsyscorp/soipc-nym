...
<body class="bodygen bgcol" onload="IniSesion('<?=$iduse?>', '<?=$sUserName?>', '<?=$sSucSet[0]?>', '<?=$caja?>'); ConsAlert('<?=$sSucSet[0]?>', '<?=$iduse?>'); ConsClose('<?=$sSucSet[0]?>', '<?=$caja?>'); LoadOpsInf('<?=$sSucSet[0]?>', '<?=$caja?>'); ConsSals('<?=$sSucSet[0]?>'); ConsTasasCV('<?=$sSucSet[0]?>'); ConsTras('<?=$sSucSet[0]?>', '<?=$caja?>'); ConsTasasAlert('<?=$sSucSet[0]?>')">
<?=$dwt=MsWait(45, 215)?>
<div class="dcabe_1 bgcol_2 dlin_2" style="position:fixed; top:0px; left:0px; z-index:5; overflow:visible">
	...
	<div style="float:left; margin-left:7px; margin-top:4px" class="fgreen"><?=$sGenSet[0]?> - <?=$sSucSet[0]?></div>
	<?
		if($sSucSet[0] != "GEN"){
	?>
	...
	<div style="float:right; margin-right:3px; position:relative; outline:0" class="dmMain" tabindex="0" onblur=""><img src="images/alert.png" style="height:24px; width:auto" onclick="waitim('dMAlerts1'); menusol('dMAlerts'); ShowAlerts('<?=$sSucSet[0]?>', '<?=$iduse?>')"/>
	...
	<div style="float:right; margin-right:3px; position:relative; outline:0" class="dmMain" tabindex="0" onblur=""><img src="images/traslado.png" style="height:24px; width:auto" onclick="waitim('dTrasa1'); menusol('dTrasa'); ShowTrasa('<?=$sSucSet[0]?>', '<?=$caja?>', '<?=$sUserName?>')"/>
		<div style="position:absolute; left:13px; top:0px; z-index:70">
	...
	<div class="bgcol_1 dlin_3 drod_1 fcont" style="margin:5px; padding:4px; height:97%; overflow:auto">
		...
		<div>
			...
			<div id="Ventanilla" style="margin-left:7px; height:auto; overflow:hidden">
				...
				-->
				<div class="dMenOpt" onclick="clicmen('frOpsClientes', 'var1=Dec&var2=<?=$sUserAcces[1]?>&var3=<?=$sSucSet[0]?>&var4=<?=$caja?>&var5=<?=$sUserName?>')"><img src="images/window.png" class="imMenu" /><div>Conocimiento clientes</div></div>
				<div class="dMenOpt" onclick="clicmen('frOpsCompra', 'var4=<?=$sSucSet[0]?>&var5=<?=$caja?>&var6=<?=$sUserName?>')"><img src="images/window.png" class="imMenu" /><div>Compra de divisas</div></div>
				<div class="dMenOpt" onclick="clicmen('frOpsVenta', 'var4=<?=$sSucSet[0]?>&var5=<?=$caja?>&var6=<?=$sUserName?>')"><img src="images/window.png" class="imMenu" /><div>Venta de divisas</div></div>
				<div class="dMenOpt" onclick="clicmen('frOpsAjustes', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=<?=$sUserName?>')"><img src="images/window.png" class="imMenu" /><div>Ajuste recursos</div></div>
				<div class="dMenOpt" onclick="clicmen('frOpsEgresos', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=<?=$sUserName?>')"><img src="images/window.png" class="imMenu" /><div>Egresos ventanilla</div></div>
				<div class="dMenOpt" onclick="clicmen('frOpsAnula', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=<?=$sUserName?>&var4=VENTANILLA&var5=NO')"><img src="images/window.png" class="imMenu" /><div>Anular operación</div></div>
				<div class="dMenOpt" onclick="clicmen('frFindOps', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=<?=$sUserName?>&var4=VENTANILLA')"><img src="images/look.png" class="imMenu" /><div>Buscar operación</div></div>
				...
				?>
				<div class="dMenOpt" onclick="clicmen('frRepConsOps', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=<?=$sUserName?>&var4=PRI')"><img src="images/reports.png" class="imMenu" /><div>Reporte movimiento</div></div>
				<?php } else { ?>
				<div class="dMenOpt" onclick="clicmen('frRepConsOps', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=<?=$sUserName?>&var4=CAJA')"><img src="images/reports.png" class="imMenu" /><div>Reporte movimiento</div></div>
				<?php } ?>
				<div class="dMenOpt" onclick="clicmen('frRepConsOps', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=<?=$sUserName?>&var4=CIERRE')"><img src="images/closev.png" class="imMenu" /><div>Cierres ventanilla</div></div>
			</div>
			...
			<div id="Otras herramientas" style="margin-left:7px; height:0px; overflow:hidden">
				<div class="dMenOpt" onclick="clicmen('frOpsCliComent', 'var2=<?=$sSucSet[0]?>&var3=<?=$caja?>&var4=<?=$sUserName?>')"><img src="images/window.png" class="imMenu" /><div>Comentario operación</div></div>
					<?php
					if($sUserName=='MIREYA MORA' ){ //usuario habilitado para actualizar lista clinton 06/03/2023 inserta juan camilo
				?>
				...
				<?php
					if($caja == 01){ //Caja principal puede hacer reportes de las otras cajas
				?>
				<div class="dMenOpt" onclick="clicmen('frRepTotComVen', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=PRI')"><img src="images/reports.png" class="imMenu" /><div>Total compra y venta</div></div>
				<div class="dMenOpt" onclick="clicmen('frRepOpsClose', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=PRI')"><img src="images/reports.png" class="imMenu" /><div>Validar cierres</div></div>
				<?php } else { ?>
				<div class="dMenOpt" onclick="clicmen('frRepOpsClose', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=CAJA')"><img src="images/reports.png" class="imMenu" /><div>Total compra y venta</div></div>
				<div class="dMenOpt" onclick="clicmen('frConsView', 'var1=frRepConsClie')"><img src="images/reports.png" class="imMenu" /><div>Consolidado cliente</div></div>	
				<?php } ?>
			</div>
		</div>
		...
		<div>
			...
			<div id="Coordinación" style="margin-left:7px; height:auto; overflow:hidden">
				...
				<div class="dMenOpt" onclick="clicmen('frOpsAnula', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=<?=$sUserName?>&var4=VENTANILLA&var5=SI')"><img src="images/window.png" class="imMenu" /><div>Anular ops. ventanilla</div></div>
				...
				<div class="dMenOpt" onclick="clicmen('frRepConsOps', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=<?=$sUserName?>&var4=COORDINA')"><img src="images/reports.png" class="imMenu" /><div>Consolidado ventanilla</div></div>
				<div class="dMenOpt" onclick="clicmen('frRepTotComVen', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=COORDINA')"><img src="images/reports.png" class="imMenu" /><div>Total compra y venta</div></div>
				<div class="dMenOpt" onclick="clicmen('frRepOpsClose', 'var1=<?=$sSucSet[0]?>&var2=<?=$caja?>&var3=COORDINA')"><img src="images/reports.png" class="imMenu" /><div>Validar cierres</div></div>
			...
			<div id="Cumplimiento" style="margin-left:7px; height:auto; overflow:hidden">
				...
				<div class="dMenOpt" onclick="MenuAccess('Actualizaciones y registros')"><img src="images/file.png" class="imMenu" /><div>Actualizaciones y registros</div></div>
					<div id="Actualizaciones y registros" style="margin-left:7px; height:0px; overflow:hidden">
						...
						<div class="dMenOpt" onclick="clicmen('frOpsClientes', 'var1=Dec&var2=<?=$sUserAcces[1]?>&var3=<?=$sSucSet[0]?>&var4=<?=$caja?>&var5=<?=$sUserName?>')"><img src="images/window.png" class="imMenu" /><div>Modificar clientes</div></div>
						<div class="dMenOpt" onclick="clicmen('frCumpClinton', 'var1=<?=$sUserName?>')"><img src="images/window.png" class="imMenu" /><div>Actualizar lista Clinton</div></div>
					</div>
		...
		<div style="width:99%; margin-top:4px; padding-bottom:5px; padding-top:5px; overflow:hidden;" class="bgcol_1 dlin_3 drod_1">
			<div style="margin-bottom:10px">
				...
				<div style="float:left; margin-left:9px">
					...
					<div>
						<select name="cbMCCurr" id="cbMCCurr" style="width:58px; font-weight:bold" class="txboxo" onchange="cbMCCurr_Change('<?=$sSucSet[0]?>', '<?=$caja?>')">
							<option value=""></option>
							<?=$cbCurLoad=LoadConfTab($link, "SELECT Moneda FROM Arqueo_Ventanilla WHERE Sucursal = '". $sSucSet[0]. "' AND Estacion = '". $caja. "'")?>
						</select>				
					</div>
				</div>
